...
public:
	...
	static __forceinline C_BaseEntity* GetEntityByIndex(int index) {
		return static_cast<C_BaseEntity*>(I::EntityList->GetClientEntity(index));
	}
	static __forceinline C_BaseEntity* get_entity_from_handle(CBaseHandle h) {
		return static_cast<C_BaseEntity*>(I::EntityList->GetClientEntityFromHandle(h));
	}
...
public:
	...
	{
		return static_cast<C_BasePlayer*>(GetEntityByIndex(I::Engine->GetPlayerForUserID(id)));
	}
	...
	{
		static unsigned int _m_surfaceFriction = U::FindInDataMap(GetPredDescMap(), "m_surfaceFriction");
		return *(float_t*)((uintptr_t)this + _m_surfaceFriction);
	}
	Vector &m_vecBaseVelocity()
	{
		static unsigned int _m_vecBaseVelocity = U::FindInDataMap(GetPredDescMap(), "m_vecBaseVelocity");
		return *(Vector*)((uintptr_t)this + _m_vecBaseVelocity);
	}

	float_t &m_flMaxspeed()
	{
		static unsigned int _m_flMaxspeed = U::FindInDataMap(GetPredDescMap(), "m_flMaxspeed");
